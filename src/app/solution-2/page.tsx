...
export default function Solution2Page() {
	...
	const networkInfrastructurePoints = calculateServicePoints(
		networkInfrastructureServices.length
	);
	const firewallSecurityPoints = calculateServicePoints(
		firewallSecurityServices.length
	);
	...
	useEffect(
		() =>
			createAnimation(setRedBarTop3, setActiveIndex3, nocMonitoringPoints, 365, 1600),
		[]
	);
	useEffect(
		() =>
			createAnimation(setRedBarTop4, setActiveIndex4, managedITPoints, 365, 2400),
		[]
	);
	useEffect(
		() =>
			createAnimation(setRedBarTop5, setActiveIndex5, optimizationPoints, 365, 3200),
		[]
	);
	useEffect(
		() =>
			createAnimation(setRedBarTop6, setActiveIndex6, multiVendorPoints, 365, 4000),
		[]
	);
					...
					<div className="rounded-[21px] bg-[#F8F8F8] py-4 sm:py-6 lg:py-[40px]">
						...
						<div className="mb-6 sm:mb-8 lg:mb-[30px] grid gap-4 sm:gap-6 lg:gap-8 grid-cols-1 lg:grid-cols-2">
							...
							<div className="w-full">
								...
								<div
									className="hidden lg:block relative w-full max-w-[719px]"
									style={{ height: "365px" }}
								>
									<div
						...
						<div className="w-full">
							<div className="mb-3 sm:mb-4 lg:mb-[20px]">
								<h3 className="font-['TASA_Orbiter'] text-black mb-1.5 sm:mb-2 lg:mb-[10px] text-xl sm:text-2xl md:text-3xl lg:text-[40px]">
									Outcome
								</h3>
								<p className="font-['TASA_Orbiter'] text-black text-base sm:text-lg md:text-xl lg:text-2xl xl:text-[32px]">
							...
							<Link
								...
								className="inline-flex items-center justify-center gap-2 sm:gap-3 rounded-[75px] border border-white/30 bg-black transition-all hover:bg-black/90 px-4 py-2.5 sm:px-6 sm:py-3"
							>
								<span className="font-['Manrope'] text-white text-xs sm:text-sm lg:text-[15px]">
									Let's Discuss Needs
								</span>
								<svg
									width="5"
					...
					<div className="rounded-[21px] bg-[#F8F8F8] py-4 sm:py-6 lg:py-[40px]">
						...
						<div className="mb-6 sm:mb-8 lg:mb-[30px] grid gap-4 sm:gap-6 lg:gap-8 grid-cols-1 lg:grid-cols-2">
							...
							<div className="w-full">
								...
								<ul className="lg:hidden space-y-3 sm:space-y-4">
									{firewallSecurityServices.map((service, i) => (
										<li key={i} className="font-['TASA_Orbiter'] text-black text-sm sm:text-base flex items-start gap-2">
											<span className="text-[#E11E24] mt-1">•</span>
											{service}
										</li>
									))}
